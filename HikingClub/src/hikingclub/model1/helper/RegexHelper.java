...
public class RegexHelper {
	...
	// 싱글톤 객체로 유일하게 생성자에 접근할 수 있는 메서드
	 ...
	 */
	public boolean inNum(String str) {
		boolean result = false;
		if (isValue(str)) {
	...
	/**
	 * 이메일 형식인지에 대한 형식 검사, "아이디@도메인"의 형식을 충족
	 * 
	 * @param str - 검사할 문자열
	 * @return boolean - 형식에 맞을 경우 true, 맞지 않을 경우 false
	 */
	...
	/**
	 * "-"없이 전화 번호인지에 대한 형식검사, 각 부분에 대한 자릿수도 충족
	 * 
	 * @param str - 검사할 문자열
	 * @return boolean - 형식에 맞을 경우 true, 맞지 않을 경우 false
	 */
	public boolean isTell(String str) {
		boolean result = false;
		if (isValue(str)) {
	...
	/**
	 * "-"없이 주민번호에 대한 글자수 및 뒷자리 첫글자가 1~4의 범위에 있는지에 대한 형식검사
	 * 
	 * @param str - 검사할 문자열
	 * @return boolean - 형식에 맞을 경우 true, 맞지 않을 경우 false
	 */
